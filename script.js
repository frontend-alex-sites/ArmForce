...
const athletesDatabase = {
  men: {
    ...
    right: [
      { name: "Новиков Алексей", rating: 2420, rank: "МС" },
      { name: "Морозов Денис", rating: 2350, rank: "КМС" },
      { name: "Волков Сергей", rating: 2280, rank: "1р" },
      { name: "Алексеев Павел", rating: 2220, rank: "2р" },
      { name: "Семенов Игорь", rating: 2160, rank: "3р" },
      { name: "Егоров Артем", rating: 2120, rank: "КМС" },
      { name: "Павлов Роман", rating: 2080, rank: "1р" },
      { name: "Степанов Виктор", rating: 2030, rank: "2р" },
      { name: "Григорьев Евгений", rating: 1980, rank: "3р" },
      { name: "Федоров Максим", rating: 1930, rank: "КМС" },
    ],
  },
  "juniors-men-14-15": {
    left: [
  ...
  women: {
    left: [
      { name: "Иванова Анна", rating: 2150, rank: "МС" },
      { name: "Петрова Елена", rating: 2080, rank: "КМС" },
      { name: "Сидорова Мария", rating: 2000, rank: "1р" },
      { name: "Смирнова Ольга", rating: 1950, rank: "2р" },
      { name: "Кузнецова Татьяна", rating: 1880, rank: "3р" },
      { name: "Васильева Ирина", rating: 1850, rank: "КМС" },
      { name: "Попова Наталья", rating: 1800, rank: "1р" },
      { name: "Соколова Юлия", rating: 1750, rank: "2р" },
      { name: "Лебедева Светлана", rating: 1700, rank: "3р" },
      { name: "Козлова Екатерина", rating: 1650, rank: "КМС" },
    ],
    right: [
      { name: "Новикова Дарья", rating: 2120, rank: "МС" },
      { name: "Морозова Алина", rating: 2050, rank: "КМС" },
      { name: "Волкова Виктория", rating: 1980, rank: "1р" },
      { name: "Алексеева Ксения", rating: 1930, rank: "2р" },
      { name: "Семенова Анастасия", rating: 1860, rank: "3р" },
      { name: "Егорова Полина", rating: 1830, rank: "КМС" },
      { name: "Павлова Ангелина", rating: 1780, rank: "1р" },
      { name: "Степанова Валерия", rating: 1730, rank: "2р" },
      { name: "Григорьева Ульяна", rating: 1680, rank: "3р" },
      { name: "Федорова Милана", rating: 1630, rank: "КМС" },
    ],
  },
  "juniors-women-14-15": {
    left: [
