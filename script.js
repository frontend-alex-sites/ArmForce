...
const weightCategories = {
  men: ["55", "60", "65", "70", "75", "90", "100", "110", "110+"],
  "juniors-men-14-15": ["50", "55", "60", "65", "70", "70+"],
  "juniors-men-16-18": ["55", "60", "65", "70", "75", "80", "80+"],
  "juniors-men-19-21": ["55", "60", "65", "70", "75", "80", "90", "90+"],
  women: ["50", "55", "70"],
  "juniors-women-14-15": ["40", "55", "60", "70"],
  "juniors-women-16-18": ["50", "55", "60", "70+"],
  "juniors-women-19-21": ["70"],
};
...
function renderAthletes(athletes, containerId, colorClass) {
  ...
  athletes.forEach((athlete, index) => {
    ...
    if (rankText === "1р") rankClass = "rank-1";
    else if (rankText === "2р") rankClass = "rank-2";
    else if (rankText === "3р") rankClass = "rank-3";
    else if (rankText === "КМС") rankClass = "rank-kms";
    else if (rankText === "МС" || rankText === "ЗМС") rankClass = "rank-ms";
    ...
    html += `
      <div class="rating-item">
        ...
        <div class="athlete-info">
          ...
          <div class="athlete-rank ${rankClass}">${rankText}</div>
        </div>
...
function createWeightSubmenu(category, colorClass, button) {
  ...
  if (weights.length === 0 && ratingData && ratingData.categories[category]) {
    weights.push(...Object.keys(ratingData.categories[category]));
  }
